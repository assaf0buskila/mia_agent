...
| ADR-049 | SITE Mia answers first; contact only for Assaf or Sheet | accepted |
| ADR-050 | Two-state tools and Tel Aviv calendar write gate | accepted |
| ADR-051 | Visitor replies never name tools; owner STT/images/Sheets aliases | accepted |
| ADR-052 | Delete the dead Sheets mirror and the unread meeting-first flag | accepted |
| ADR-053 | Site Mia sells on a ladder; WhatsApp waits on Baileys | accepted |
