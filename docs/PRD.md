...
| Surface | Role |
| --- | --- |
    | Website | Primary customer sales. One bottom control: visible Ask Mia pill (opens on click). Mic lives in the open composer (voice in, STT, same sales graph). No TTS. No competing WhatsApp FAB. Chat uses sent/received bubbles with avatars. Customer Hebrew is 2nd-person plural / impersonal (men and women). WhatsApp offer after real context (ADR-018), typically 3–6 meaningful exchanges. |
...
| LinkedIn | Profile + member analytics read. No posts/DMs. |
