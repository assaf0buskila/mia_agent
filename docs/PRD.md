...
| Gmail | Inbox list/search/read via typed port. Summarize ingested threads. Draft on owner request; send only after Approve and `MIA_GMAIL_SEND` (default false). |
