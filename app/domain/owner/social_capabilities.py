...
def format_social_capabilities(caps: SocialCapabilities) -> str:
    ...
    linkedin_write_line = (
        ...
        "בסביבה החיה, ואין בדיקה חוזרת עצמאית שזה באמת מופיע ב-LinkedIn אחר כך."
    ...
    lines = [
        ...
        f"- קריאת פרופיל LinkedIn: {linkedin_read}. הפרופיל המחובר בלבד, בלי "
        ...
        "- הודעות ישירות ומודעות ב-Instagram: לא זמינות בשום מסלול.",
